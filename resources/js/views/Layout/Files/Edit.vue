                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group bmd-form-group pt-4">
                                                    <input type="text" name="name_persion" v-model="form.name_persion" class="form-control"
                                                           placeholder="نام خواننده ">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group bmd-form-group pt-4">
                                                    <input type="text" name="name_english" v-model="form.name_english" class="form-control"
                                                           placeholder="نام خواننده انگلیسی ">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group bmd-form-group">
                                                    <input type="text" name="name_music_persion" v-model="form.name_music_persion" class="form-control"
                                                           placeholder="نام اهنگ">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group bmd-form-group">
                                                    <input type="text" name="name_music_english" v-model="form.name_music_english" class="form-control"
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group bmd-form-group">
                                                    <select class="form-select form-select-lg col-md-12  mb-3 mt-3custom-select" id="inputGroupSelect02">
                                                        <option value="volvo" class="form-control form-select-lg mb-5"
                                                        >
                                                            دسته بندی انتخاب کنید
                                                        </option>
                                                        <option class="form-control form-select-lg mb-5"
                                                                name="category"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group bmd-form-group">
                                                    <input type="text" name="title" v-model="form.title" class="form-control" placeholder="موضوع">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group bmd-form-group">
                                                    <input type="text" name="slug" v-model="form.slug" class="form-control" placeholder="اسلاگ">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group bmd-form-group">
                                                        <textarea class="form-control" v-model="form.caption" rows="3" name="caption"
