                                ...
                                <div class="card-body">
                                    <form  @submit.prevent="storeFile"  enctype="multipart/form-data">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group bmd-form-group pt-4" >
                                                    <input type="text" v-model="form.slug" name="slug"   class="form-control" placeholder="اسلاگ ">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group bmd-form-group pt-4" >
...
export default {
    ...
    methods: {
        ...
        storeFile() {
            ...
            axios.post('http://127.0.0.1:8000/api/biographi' , formData)
                .then(({data}) => {
                    console.log(data)
